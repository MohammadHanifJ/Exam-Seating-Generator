      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-orange-100 bg-white/80 p-4">
            <label className="text-[10px] uppercase tracking-[0.35em] text-slate-500">Step 1 • Exam Type</label>
          ...
          <div className="rounded-2xl border border-orange-100 bg-white/80 p-4">
            <label className="text-[10px] uppercase tracking-[0.35em] text-slate-500">Step 2 • Add Branch + Year</label>
          ...
          <div className="rounded-2xl border border-orange-100 bg-white/80 p-4">
            <label className="text-[10px] uppercase tracking-[0.35em] text-slate-500">Step 3 • Rooms</label>
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[11px] font-semibold text-slate-700">Room Capacity (Number of Seats)</label>
                <p className="text-[10px] text-slate-500">Enter the total number of seats available in this room</p>
                <input
                  type="number"
                  value={capacity}
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-orange-100 bg-white/80 p-4 lg:col-span-2">
            <h3 className="text-[10px] uppercase tracking-[0.35em] text-slate-500">Step 3 • Classrooms</h3>
                        ...
                        return (
                          <tr key={room.room_no} className="border-t border-orange-100 text-slate-700">
                            ...
                            <td className="py-3 px-4">
                              ...
                              >
                                {selected ? "Selected" : `Select (${room.room_no} • ${room.capacity})`}
                              </button>
                            </td>
                          </tr>
                        );
        ...
        <div className="rounded-2xl border border-orange-100 bg-white/80 p-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h3 className="text-[10px] uppercase tracking-[0.35em] text-slate-500">Step 4 • Invigilators</h3>
